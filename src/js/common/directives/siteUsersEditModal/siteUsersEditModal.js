/*global $*/
app.directive('siteUsersEditModal', ['$modal', 'SiteModelUpdateService', 'Api', '$window', '$timeout', function ($modal, SiteModelUpdateService, Api, $window, $timeout) {
    'use strict';
    ...
    var linker = function (scope, el, attrs) {
        ...
        scope.openModal = function (id) {
            ...
            if (!modal) {
                modal = $modal({
                    scope: scope,
                    template: '/js/common/directives/siteUsersEditModal/siteUsersEditModal.tpl.html',
                    show: false
                });
            }
